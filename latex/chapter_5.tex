...
Top-N overlap and Spearman/Kendall rank statistics highlighted the utility of MLPs in screening contexts. Even where absolute energies were misaligned, the preservation of top candidate rankings proved robust in Ge and Sn systems \cite{Davies2024-ju, Deng2023-tg, Kao2025-ay, Gerber2023-yd, Rosen2022-pw, Butler2019-ws, Di_Liberto2022-gz}.
...
MLPs may struggle with the directional covalent bonding and short bond lengths characteristic of Si. These features introduce sensitivity to structural distortions that are difficult to learn from sparse data \cite{Batatia2022-xz, Hepplestone2006-lo, Rosen2022-pw, Butler2019-ws, Di_Liberto2022-gz}.

\subsubsection{Underrepresented environments in training?}

It is likely that the MACE training set lacks sufficient coverage of interfacial Si environments, especially those with reconstructed surfaces and strained bonds. \cite{Batatia2022-xz, Davies2024-ju, Deng2023-tg, Rosen2022-pw, Butler2019-ws, Di_Liberto2022-gz}
...
MLPs appear trustworthy when used to rank candidates in systems whose bonding and local structures are well-represented in the training data. Screening workflows benefit most from MLPs in Ge and Sn contexts \cite{Batatia2022-xz, Davies2024-ju, Deng2023-tg, Gerber2023-yd, Rosen2022-pw, Butler2019-ws, Di_Liberto2022-gz}.

\subsection{Necessity of retraining, delta-correction, or hybrid workflows}

The results support the need for delta-correction approaches, particularly for challenging systems like Si. Hybrid workflows that combine MLP-based pre-screening with DFT confirmation for top candidates offer a balanced path forward. \cite{Batatia2022-xz, Davies2024-ju, Deng2023-tg, Uhrin2025-ba, Gerber2023-yd, Rosen2022-pw, Butler2019-ws, Di_Liberto2022-gz}

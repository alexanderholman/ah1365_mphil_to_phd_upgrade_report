...
\subsection{Lattice Mismatch and Supercells}
...
% todo: add details on how to set up VASP for interface modelling, e.g. INCAR, POSCAR, KPOINTS, POTCAR files.
% todo: add details on KPOINTS and how to choose them for interface modelling.
% ---------- %

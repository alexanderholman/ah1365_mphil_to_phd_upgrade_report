...
\begin{enumerate}
    ...
    \]
    thereby minimizing lattice mismatch strain\cite{artemis_paper, ZurMcGill1984-lattice}. Candidate supercells (integer multiples of slab
...
% todo: add figure of ARTEMIS algorithm
